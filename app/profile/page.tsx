        ...
        <div className="max-w-2xl mx-auto p-4 pt-16">
          <div className="flex justify-end items-center mb-6">
            <button 
              ...
              className="bg-black/80 backdrop-blur-sm px-4 py-2 rounded-md text-primary-blue border border-primary-blue hover:bg-black/90 transition-colors flex items-center mt-4"
            >
